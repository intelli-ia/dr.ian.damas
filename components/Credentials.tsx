...
const cards = [
  ...
  },
  {
    ...
    description:
      "Esteve na Globo e em portais médicos como fonte de confiança.",
  },
];
  ...
  return (
    <section className="bg-primary py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <h2 className="text-3xl lg:text-4xl font-bold text-secondary text-center mb-14">
          Experiência que vai{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-14">
          {cards.map((card) => (
            /* Mobile: card simples — Desktop: GlowCard com efeito spotlight */
            <div key={card.title} className="block">
              {/* Mobile */}
              <div className="md:hidden bg-secondary/10 border border-secondary/20 rounded-sm p-8 flex flex-col gap-4">
                <CheckIcon />
              ...
              <GlowCard
                glowColor="orange"
                className="hidden md:flex flex-col gap-4 p-8 border-secondary/20"
              >
                <CheckIcon />
                <h3 className="text-secondary font-bold text-lg leading-snug">{card.title}</h3>
                <p className="text-secondary/70 text-sm leading-relaxed">{card.description}</p>
        ...
        <div className="flex justify-center">
          <ShinyButton
            ...
            className="bg-tertiary text-primary px-10 py-4"
          >
