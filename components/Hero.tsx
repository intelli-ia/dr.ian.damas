...
export default function Hero() {
  return (
    <section className="bg-primary min-h-screen relative overflow-hidden flex items-center">

      {/* Efeito FloatingPaths — lado direito */}
      <FloatingPaths position={1} flip />
      <FloatingPaths position={-1} flip />

      {/* Imagem — ocupa toda a altura da seção, ancorada à direita */}
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-6 lg:px-12 w-full py-20">
        {/* w-max: container dimensionado pelo conteúdo, sem limite artificial */}
