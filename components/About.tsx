export default function About() {
  return (
    <section className="bg-secondary relative overflow-hidden">
      ...
      <div className="lg:hidden flex flex-col items-center text-center">
        ...
        <div className="flex flex-col gap-4 px-6 py-10">
          <div>
            ...
            <p className="text-primary/50 text-xs font-medium tracking-wide mt-1">
          ...
          <p className="text-primary/80 text-sm leading-relaxed">
            ...
            perguntas e fornecer o apoio que você precisa durante todo o processo.
          </p>
          <p className="text-primary/80 text-sm leading-relaxed">
      ...
      {/* ── DESKTOP ────────────────────────────────────────── */}
      <div className="hidden lg:flex min-h-[680px] items-center relative overflow-hidden">
